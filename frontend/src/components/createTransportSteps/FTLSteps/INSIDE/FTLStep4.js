import { Button, Col, Row, Form, Select, InputNumber, Input } from 'antd';
...
//FTL STEP 4
const FTLStep4 = ({ handleClickNextStep, handleClickPrevStep, ftlForm, setFtlForm }) => {
    const { t, i18n } = useTranslation("common");

    const formValues = {
        trailerFeatureIdList: ftlForm.trailerFeatureIdList,
        trailerTypeIdList: ftlForm.trailerTypeIdList,
        trailerFloorTypeIdList: ftlForm.trailerFloorTypeIdList,
        vehicleCount: ftlForm.vehicleCount,
        vehicleTypeIdList: ftlForm.vehicleTypeIdList,
                ...
                <Row gutter={[24, 24]}>
                    <Col xs={24} xl={12} xxl={8}>
                        ...
                        >
                            <Select
                                ...
                                allowClear
                                onChange={v => setFtlForm({ ...ftlForm, vehicleTypeIdList: [v] })}
                            >
                                {
                    ...
                    <Col xs={24} xl={12} xxl={8}>
                        ...
                        >
                            <NumberFormat
                                customInput={Input}
                                onValueChange={({ value }) => setFtlForm({ ...ftlForm, vehicleCount: value })}
                    ...
                    <Col xs={24} xl={12} xxl={8}>
                        ...
                        >
                            <Select
                                ...
                                placeholder={t("Farketmez")}
                                allowClear
                                onChange={v => setFtlForm({ ...ftlForm, trailerTypeIdList: [v] })}
                            >
                                {
                    ...
                    <Col xs={24} xl={12} xxl={8}>
                        ...
                        >
                            <Select
                                ...
                                placeholder={t("Farketmez")}
                                allowClear
                                onChange={v => setFtlForm({ ...ftlForm, trailerFloorTypeIdList: [v] })}
                            >
                                {
                    ...
                    <Col xs={24} xl={12} xxl={8}>
                        ...
                        >
                            <Select
                                ...
                                onChange={v => setFtlForm({ ...ftlForm, trailerFeatureIdList: v })}
                            >
                                {
