...
const PartialStep1 = ({ handleClickNextStep, handleClickPrevStep, partialForm, setPartialForm, adStartingDate, setAdStartingDate }) => {
    ...
    const formValues = {
        ...
        zipCode: partialForm.startingAddress.zipCode,
        country: partialForm.startingAddress.country,
                    ...
                    <Row gutter={[24, 24]}>
                        ...
                        <Col xs={24} xl={12} xxl={8}>
                            ...
                            >
                                <Input
                                    size="large"
                                    placeholder={t("Yükleme yapılacak ülkeyi girin")}
                                    onChange={e => {
                                        partialForm.startingAddress.country = e.target.value
                                        setPartialForm({ ...partialForm })
                                    }}
                                />
                            </Form.Item>
                        ...
                        <Col xs={24} xl={12} xxl={8}>
                            ...
                            >
                                <Input
                                    ...
                                    onChange={e => {
                                        partialForm.startingAddress.province = e.target.value
                                        setPartialForm({ ...partialForm })
                                    }}
                                />
                            </Form.Item>
                        ...
                        <Col xs={24} xl={12} xxl={8}>
                            ...
                            >
                                <NumberFormat
                                    size="large"
                                    /*  minLength={13} */
                                    placeholder={t("Yükleme yapılacak şehrin posta kodunu girin")}
                                    customInput={Input}
                                    onValueChange={({ floatValue }) => {
                                        partialForm.startingAddress.zipCode = floatValue
                                        setPartialForm({ ...partialForm })
                                    }}
                                />
                            </Form.Item>
                        ...
                        <Col xs={24} xl={12} xxl={8}>
                            ...
                            >
                                <Input
                                    size="large"
                                    placeholder={t("Yükleme yapılacak yerin tam adresini girin")}
                                    onChange={e => {
