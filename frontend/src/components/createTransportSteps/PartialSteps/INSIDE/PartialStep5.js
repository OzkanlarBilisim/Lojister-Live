                ...
                <Col xs={24} md={12} lg={6}>
                    <div style={{ boxSizing: "border-box", display: "flex", flexDirection: "column", padding: "1rem", backgroundColor: "#fff", borderRadius: "1rem", gap: "1rem" }}>
                        ...
                        <CustomLabel title={t("Adres")}>
                            {partialForm.startingAddress.fullAddress + " " + partialForm.startingAddress.neighborhood + " - " + partialForm.startingAddress.district + "/" + partialForm.startingAddress.province}
                        </CustomLabel>
                    </div >
                </Col >
                <Col xs={24} md={12} lg={6}>
                    <div style={{ boxSizing: "border-box", display: "flex", flexDirection: "column", padding: "1rem", backgroundColor: "#fff", borderRadius: "1rem", gap: "1rem" }}>
                        ...
                        <CustomLabel title={t("Adres")} >
                            {partialForm.dueAddress.fullAddress + " " + partialForm.dueAddress.neighborhood + " - " + partialForm.dueAddress.district + "/" + partialForm.dueAddress.province}
                        </CustomLabel >
                    </div >
                </Col >
                <Col xs={24} md={12} lg={6}>
