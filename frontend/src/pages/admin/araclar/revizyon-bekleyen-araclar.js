...
import { createVehicleStatusRequest, getVehicleRevisionStatusRequest } from '../../../api/controllers/vehicle-controller';
...
const AdminRevizyonBekleyenSuruculer = () => {
    ...
    const fetchVehicles = async () => {
        setIsLoading(true);
        try {
            let res = await getVehicleRevisionStatusRequest();
            if (res) {
