...
import { getAllPaymentsRequest, getPaymentDetailByTransportProcessIdRequest } from '../../../api/controllers/transport-payment-controller';
import SuspenseFallbackInline from '../../../components/SuspenseFallbackInline';

const AdminTumOdemeler = () => {
    ...
    useEffect(() => {
        const fetchPayments = async () => {
            setIsLoading(true);
            try {
                let res = await getAllPaymentsRequest();
                if (res) {
...
export default AdminTumOdemeler;